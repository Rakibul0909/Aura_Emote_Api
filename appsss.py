...
async func def DecodeWhisperMessage(hex_packet):
    ...
    while True:    
        try:    
            ...
            if LoGinDaTaUncRypTinG.Clan_ID:    
                ...
                if whisper_writer: 
                    whisper_writer.write(pK) ; await whisper_writer.drain()    
            while True:    
...
async def MaiiiinE():
    ...
    Uid, Pw = '4428929944', '51E602676D19C35FCCD2FDDDF7B8CF0786FF6CH687106ED24157FCC6AD01DBD37'
